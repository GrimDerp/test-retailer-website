...
var MERCHANT_DOMAIN = "test-retailer.narvar.qa";
...
app.post('/makeNarvarCall', function (req, res) {
	console.log('hit /makeNarvarCall');
	console.log(req.body.registrationId + " " + req.body.amount);

	var options = {
		url: _config2.default.retailerURL + "/PaymentsAPI/Credit/SaleByRecordNo",
		method: 'post',
		headers: {
			"content-type": "application/json",
			"accept": "*/*",
			"authorization": "Basic " + _config2.default.retailerAuth
		},
		body: {
			"OperatorID": "TEST",
			"InvoiceNo": "123456",
